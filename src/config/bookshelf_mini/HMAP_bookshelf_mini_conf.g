...
box(shelf): { rel: [0.21, -0.6, 0.615, 1, 0, 0, 0], joint: rigid, shape: box, size: [0.06, 0.2, 0.2, 0.5], color: [0, 1, 1], contact: 1, mass: 0.1, inertia: [0.000666667, 0.000363333, 0.000363333] },
