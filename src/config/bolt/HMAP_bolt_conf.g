world: {  },
table(world): { shape: ssBox, size: [4, 4, 0.1, 0.02], color: [0.3, 0.3, 0.3], contact: 1 },
lock(table): {  },
lock_top(lock): { rel: [-0.6, 0.25, 0.208, -1, 0, 0, 0], shape: box, size: [0.3, 0.14, 0.03, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.0007575, 0.000913333] },
lock_side(lock): { rel: [-0.6, 0.15, 0.12, -1, 0, 0, 0], shape: box, size: [0.3, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000913333, 0.0007575] },
lock_side2(lock): { rel: [-0.6, 0.35, 0.12, -1, 0, 0, 0], shape: box, size: [0.3, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000913333, 0.0007575] },
lock_0_side(lock): { rel: [-0.4, 0.15, 0.12, -1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000496667, 0.000340833] },
lock_1_side(lock): { rel: [-0.2, 0.15, 0.12, -1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000496667, 0.000340833] },
lock_1_side2(lock): { rel: [-0.2, 0.35, 0.12, -1, 0, 0, 0], shape: box, size: [0.1, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000246667, 9.08333e-05] },
lock_1_top1(lock): { rel: [-0.2, 0.16, 0.208, -1, 0, 0, 0], shape: box, size: [0.1, 0.04, 0.03, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [2.08333e-05, 9.08333e-05, 9.66667e-05] },
lock_1_top2(lock): { rel: [-0.2, 0.34, 0.208, -1, 0, 0, 0], shape: box, size: [0.1, 0.05, 0.03, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [2.83333e-05, 9.08333e-05, 0.000104167] },
lock_02_side(lock): { rel: [0, 0.15, 0.12, -1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000496667, 0.000340833] },
lock_2_top(lock): { rel: [0.1, 0.25, 0.208, -1, 0, 0, 0], shape: box, size: [0.2, 0.14, 0.03, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000340833, 0.000496667] },
lock_2_side(lock): { rel: [0.1, 0.15, 0.12, -1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000496667, 0.000340833] },
lock_2_side2(lock): { rel: [0.1, 0.35, 0.12, -1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 0.1, inertia: [0.000170833, 0.000496667, 0.000340833] },
box(lock): { rel: [-0.32, 0.25, 0.12, 1, 0, 0, 0], joint: rigid, shape: ssBox, size: [1, 0.1, 0.1, 0.04], color: [0.211, 0.321, 0.678], contact: 1, mass: 0.1, inertia: [0.000166667, 0.00841667, 0.00841667] },
head(box): { rel: [-0.05, 0.12, 0, 1, 0, 0, 0], shape: ssBox, size: [0.04, 0.3, 0.04, 0.02], color: [0, 1, 1], contact: 1, mass: 0.1, inertia: [0.000346667, 2.66667e-05, 0.000346667] },
cam_frame_0: { pose: [-0.4, 0, 2.4, 0.0007963, -1, 0, 0], shape: marker, size: [0.1] },
cam_frame_1: { pose: [0.4, 0.1, 3, 0.116852, -0.689086, -0.705023, 0.1202], shape: marker, size: [0.1] },
cam_frame_2: { pose: [-1.2, 0.1, 3, 0.126031, -0.704004, 0.687876, -0.123775], shape: marker, size: [0.1] },
