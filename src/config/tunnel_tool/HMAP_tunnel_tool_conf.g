...
box(tunnel): { rel: [-0.2, 0.25, 0.09001, 1, 0, 0, 0], joint: rigid, shape: ssBox, size: [0.3, 0.08, 0.08, 0.04], color: [0, 1, 1], contact: 1, mass: 0.1, inertia: [0.000106667, 0.000803333, 0.000803333] },
