...
bin_obs (bin)  :{ X:"t(-0.1 -0.20 0.1) d(0 0 0 1)" , shape:box, size: [0.15 0.25 0.1 0.5], color: [1 0.5 0], mass: 10,contact:1}

box (world){
  shape:ssCylinder, Q: "t(0.15 -0.2 .06) d(0 0 0 1)", size:[.001 .03 .01], color:[0 1 1], mass: .1, contact:1,friction: 0.001,
  joint:rigid
}

pawn { shape:ssCylinder, X: "t(0.25 -0.2  0.06) d(0 0 0 1)", size:[.001 .03 .01], color:[1 1 1], mass: .1, contact:1 }

pawn_handle (pawn){ shape:box, Q: "t(0 0 0.07) d(0 0 0 1)", size:[0.015 0.015 0.120 .015], color:[0 1 1], mass: .1, contact:1, friction: 100 }
