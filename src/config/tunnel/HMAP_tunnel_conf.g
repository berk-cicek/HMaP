world: {  },
table(world): { rel: [0, 0, 0.0, 1, 0, 0, 0], shape: ssBox, size: [4, 4, 0.1, 0.02], color: [0.3, 0.3, 0.3], contact: 1, mass: 1, inertia: [1.33417, 1.33417, 2.66667] },
tunnel(world): { shape: marker, size: [0.01] },
#cube(world): { rel: [0.1, 0.5, 0.6, 0.707107, 0, 0, 0.707107], joint: rigid, shape: box, size: [0.08, 0.08, 0.08, 0.04], color: [0, 0, 1], contact: 1, mass: 0.1, inertia: [0.000106667, 0.000106667, 0.000106667] },
tunnel_top(tunnel): { rel: [-0.9, 0.25, 0.165, 1, 0, 0, 0], shape: box, size: [0.9, 0.14, 0.03, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.337875, 0.345667] },
tunnel_side(tunnel): { rel: [-0.9, 0.19, 0.08, 1, 0, 0, 0], shape: box, size: [0.9, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.345667, 0.337875] },
tunnel_side2(tunnel): { rel: [-0.9, 0.31, 0.08, 1, 0, 0, 0], shape: box, size: [0.9, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.345667, 0.337875] },
tunnel_top_2(tunnel): { rel: [-0.2, 0.25, 0.165, 1, 0, 0, 0], shape: box, size: [0.2, 0.14, 0.03, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.0170417, 0.0248333] },
tunnel_side_2(tunnel): { rel: [-0.2, 0.19, 0.08, 1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.0248333, 0.0170417] },
tunnel_side2_2(tunnel): { rel: [-0.2, 0.31, 0.08, 1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.0248333, 0.0170417] },
box(table): { rel: [-0.64, 0.25, 0.09001, 1, 0, 0, 0], joint: rigid, shape: ssBox, size: [1, 0.08, 0.08, 0.04], color: [0, 1, 1], contact: 1, mass: 0.2, inertia: [0.000213333, 0.0167733, 0.0167733] },
...
r_panda_base(table): { multibody: True },
...
l_panda_base(table): { multibody: True },
