...
box(tunnel): { rel: [-0.64, 0.25, 0.09001, 1, 0, 0, 0], joint: rigid, shape: ssBox, size: [1, 0.08, 0.08, 0.04], color: [0, 1, 1], contact: 1, mass: 0.2, inertia: [0.000213333, 0.0167733, 0.0167733] },
