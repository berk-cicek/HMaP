...
box (world){
  shape:box, X: "t(0.2 -0.2 .1) d(0 0 0 1)", size:[.08 .08 .08 .04], color:[1 0 1], mass: .1, contact:1,friction: 0.001,
  joint:rigid
}

pawn { shape:box, X: "t(0.32 -0.2 0.08) d(0 0 0 1)", size:[0.04 0.04 0.04 .04], color:[1 1 1], mass: 1, contact:1}
pawn_handle (pawn){ shape:box, Q: "t(0 0 0.08) d(0 0 0 1)", size:[0.015 0.015 0.120 .015], color:[0 1 1], mass: .1, contact:1, friction: 100}
...
cam_frame_0: { pose: [0, 0.5, 1, 0.00785098,   0.00988058,   0.94824172,  -0.31729857], shape: marker, size: [0.1] },
...
l_panda_link0(l_panda_base): { rel: [0, -0.6, 0.05, -0.707388, 0, 0, -0.706825] },
