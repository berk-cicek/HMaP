...
sphere(world): { rel: [0.5, 0.25, 0.1, 0.707107, 0, 0, 0.707107], joint: rigid, shape: sphere, size: [0.05], color: [1, 0, 1], contact: 1, mass: 0.1, inertia: [0.0001, 0.0001, 0.0001] },
...
lock_top(table): { rel: [-0.3, 0.25, 0.165, -1, 0, 0, 0], shape: box, size: [0.3, 0.14, 0.03, 0.5], color: [1, 0.5, 0], contact: -1, mass: 5, inertia: [0.00854167, 0.037875, 0.0456667] },
lock_side(table): { rel: [-0.3, 0.19, 0.08, -1, 0, 0, 0], shape: box, size: [0.3, 0.03, 0.14, 0.5], color: [1, 0.5, 0], contact: -1, mass: 5, inertia: [0.00854167, 0.0456667, 0.037875] },
lock_side2(table): { rel: [-0.3, 0.31, 0.08, -1, 0, 0, 0], shape: box, size: [0.3, 0.03, 0.14, 0.5], color: [1, 0.5, 0], contact: -1, mass: 5, inertia: [0.00854167, 0.0456667, 0.037875] },
bin_side(table): { rel: [-0.7, -0.6, 0.08, -1, 0, 0, 0], shape: box, size: [0.4, 0.03, 0.14, 0.5], color: [1, 0.5, 0], contact: -1, mass: 5, inertia: [0.00854167, 0.0748333, 0.0670417] },
bin_side2(table): { rel: [-0.7, -0.2, 0.08, -1, 0, 0, 0], shape: box, size: [0.4, 0.03, 0.14, 0.5], color: [1, 0.5, 0], contact: -1, mass: 5, inertia: [0.00854167, 0.0748333, 0.0670417] },
bin_side3(table): { rel: [-0.5, -0.4, 0.08, -1, 0, 0, 0], shape: box, size: [0.03, 0.4, 0.14, 0.5], color: [1, 0.5, 0], contact: -1, mass: 5, inertia: [0.0748333, 0.00854167, 0.0670417] },
bin_side4(table): { rel: [-0.9, -0.4, 0.08, -1, 0, 0, 0], shape: box, size: [0.03, 0.4, 0.14, 0.5], color: [1, 0.5, 0], contact: -1, mass: 5, inertia: [0.0748333, 0.00854167, 0.0670417] },
box(world): { rel: [-0.3, 0.25, 0.09, 1, 0, 0, 0], joint: rigid, shape: ssBox, size: [0.3, 0.08, 0.08, 0.04], color: [0, 1, 1], contact: 1, mass: 0.1, inertia: [0.000106667, 0.000803333, 0.000803333] },
cam_frame_0: { pose: [0, 0.1, 2.6, 0.000796327, 1, 0, 0], shape: marker, size: [0.1], focalLength: 2, width: 640, height: 360, zRange: [0.5, 100] },
