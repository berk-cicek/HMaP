...
lock_top(table): { rel: [-0.9, 0.25, 0.165, -1, 0, 0, 0], shape: box, size: [0.9, 0.14, 0.03, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.337875, 0.345667] },
lock_side(table): { rel: [-0.9, 0.19, 0.08, -1, 0, 0, 0], shape: box, size: [0.9, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.345667, 0.337875] },
lock_side2(table): { rel: [-0.9, 0.31, 0.08, -1, 0, 0, 0], shape: box, size: [0.9, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.345667, 0.337875] },
lock1_top(table): { rel: [-0.2, 0.25, 0.165, -1, 0, 0, 0], shape: box, size: [0.2, 0.14, 0.03, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.0170417, 0.0248333] },
lock1_side(table): { rel: [-0.2, 0.19, 0.08, -1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.0248333, 0.0170417] },
lock1_side2(table): { rel: [-0.2, 0.31, 0.08, -1, 0, 0, 0], shape: box, size: [0.2, 0.03, 0.14, 0.5], color: [0.996, 0.478, 0.211], contact: -1, mass: 5, inertia: [0.00854167, 0.0248333, 0.0170417] },
box(world): { rel: [-0.64, 0.25, 0.14, 1, 0, 0, 0], joint: rigid, shape: ssBox, size: [1, 0.08, 0.08, 0.04], color: [0, 1, 1], contact: 1, mass: 0.2, inertia: [0.000213333, 0.0167733, 0.0167733] },
cam_frame_0: { pose: [0, 0.4, 2.6, 0.000796327, 1, 0, 0], shape: marker, size: [0.1] },
