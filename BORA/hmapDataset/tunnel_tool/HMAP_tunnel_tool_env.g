...
tunnel_top (tunnel):{ Q:"t(-0.3 0.25 0.165) d(0 0 0 1)" , shape:box, size: [0.3 0.14 0.03 0.5], color: [1 0.5 0], mass: 5,contact:-1}
tunnel_side (tunnel):{ Q:"t(-0.3 0.19 0.08) d(0 0 0 1)" , shape:box, size: [0.3 0.03 0.14 0.5], color: [1 0.5 0], mass: 5,contact:-1}
tunnel_side2 (tunnel):{ Q:"t(-0.3 0.31 0.08) d(0 0 0 1)" , shape:box, size: [0.3 0.03 0.14 0.5], color: [1 0.5 0], mass: 5,contact:-1}
box (tunnel){
