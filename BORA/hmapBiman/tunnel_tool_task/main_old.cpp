...
int main(int argc, char* argv[]) {
    ...
    C2.addFile("HMAP_tunnel_tool_actuated_env.g");  
    ...
    C.getFrame("r_panda_link0")->setPose(rai::Transformation(rai::Vector(-1, 0.4, .05), rai::Quaternion(0.7073883, 0., 0., 0.7068252)));
    C.view(true, "Initial Configuration");

    const arr qHome = C.getJointState();
    const arr qF = {-0.7, -0.4, 0.09001, 1, 0, 0, 0};
